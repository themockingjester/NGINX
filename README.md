...
chmod 755 /etc/letsencrypt/live/ <br>
chmod 755 /etc/letsencrypt/archive/ <br>
ll /etc/letsencrypt/ <br>
total 0 <br>
drwxr-xr-x. 3 root root 38 Sep 28 11:24 archive <br>
drwxr-xr-x. 3 root root 38 Sep 28 11:24 live <br>
